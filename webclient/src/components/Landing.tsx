...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-teal-500 to-emerald-500 text-white">
      ...
      <button className="bg-emerald-700 text-white py-3 px-8 rounded-full mb-8 hover:bg-emerald-500 transition duration-300 focus:outline-none focus:ring focus:border-emerald-600 border-emerald-300 border">
        Join the Club
      </button>
